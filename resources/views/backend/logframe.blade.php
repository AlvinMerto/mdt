								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">Logframe</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
								...
								<div id="kt_app_content_container" class="app-container container-fluid">
									<div>
                                        ...
                                        <div>
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <p> <i class="ki-outline ki-down fs-2"></i> <span class='badge badge-light-success fs-base py-3 px-4 fs-7 '> Goal </span> - Lorem ipsum dolor set amit  </p>
                                                </div>
                                                <div class="col-md-1">
                                                    <p> Baseline  </p>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <p class="outcome_text"> <i class="ki-outline ki-down fs-2"></i> <span class="badge py-3 px-4 fs-7 badge-light-primary"> Outcome </span> - Lorem ipsum dolor set amit  </p>
                                                </div>
                                                <div class="col-md-1">
                                                    <p>   </p>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <p class="output_text"> <i class="ki-outline ki-down fs-2"></i> <span class="badge py-3 px-4 fs-7 badge-light-warning"> Output </span> - Lorem ipsum dolor set amit  </p>
                                                </div>
                                                <div class="col-md-1">
                                                    <p> 23  </p>
                                                </div>
						...
						<div id="kt_app_footer" class="app-footer">
							...
							<div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
								...
								<div class="text-dark order-2 order-md-1">
									...
									<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">_</a>
								</div>
								<!--end::Copyright-->
								<!--begin::Menu-->
