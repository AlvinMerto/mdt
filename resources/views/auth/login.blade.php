<title> Minda Connect - Mindanao Development Tracker </title>
		<meta charset="utf-8" />
							...
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								...
								<form method="POST" action="{{ route('login') }}">
									...
									<div class="fv-row mb-8 w-100">
										<!--begin::Email-->
										<x-text-input id="email" placeholder="Email"  class="form-control bg-transparent block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
									...
									<div class="fv-row mb-3 w-100">
										<!--begin::Password-->
                                        <x-text-input id="password" class="block mt-1 w-full form-control bg-transparent" type="password" placeholder="Password" name="password" required autocomplete="current-password" />
