...
var KTAppEcommerceSaveProduct = (function () {
    ...
    return {
        init: function () {
            var o, a;
            ["#kt_ecommerce_add_product_description","#status_update_div","#kt_ecommerce_add_product_meta_description"].forEach((e) => {
                ...
                t(),
                (() => {
                    const e = document.getElementById("kt_ecommerce_add_product_status_select"),
